...
/*   Updated: 2022/01/19 19:58:08 by aabdou           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_push_index(s_stacks *stacks, int key_number) //if the numbers b4 the key_number are smaller ,push them to srack b 
{
	int	index;
